...
page name: "mDashboard"
	def mDashboard(){
		...
		if ("${mode1}" == "auto") 
        	paragraph "The ${tStat1} is ${temp1}бу. The thermostat is in ${mode1} mode, the heat is set to ${setPH1}бу, the cooling is set to ${setPC1}бу, and it is currently ${oper1}."
        if ("${mode1}" == "cool")
            paragraph "The ${tStat1} is ${temp1}бу. The thermostat is set to ${setPC1}бу, is in ${mode1} mode and is currently ${oper1}."
        if ("${mode1}" == "heat")
            paragraph "The ${tStat1} is ${temp1}бу. The thermostat is set to ${setPH1}бу, is in ${mode1} mode and is currently ${oper1}."
        if ("${mode1}" == "off")
        	paragraph "The ${tStat1} thermostat is currently ${mode1}, and the temperature is ${temp1}бу." 
		if ("${mode2}" == "auto") 
        	paragraph "The ${tStat2} is ${temp2}бу. The thermostat is in ${mode2} mode, the heat is set to ${setPH2}бу, the cooling is set to ${setPC2}бу, and it is currently ${oper2}."
        if ("${mode2}" == "cool")
            paragraph "The ${tStat2} is ${temp2}бу. The thermostat is set to ${setPC2}бу, is in ${mode2} mode and is currently ${oper2}."
        if ("${mode2}" == "heat")
            paragraph "The ${tStat2} is ${temp2}бу. The thermostat is set to ${setPH2}бу, is in ${mode2} mode and is currently ${oper2}."
        if ("${mode2}" == "off")
        	paragraph "The ${tStat2} thermostat is currently ${mode2}, and the temperature is ${temp2}бу." 
		}
		section ("Temperature Sensors") {
            ...
            if (tempSens1)
            	paragraph "The temperature of the ${tempSens1} is ${Sens1temp}бу."
            if (tempSens2)
            	paragraph "The temperature of the ${tempSens2} is ${Sens2temp}бу."
            if (tempSens3)
            	paragraph "The temperature of the ${tempSens3} is ${Sens3temp}бу."
            if (tempSens4)
            	paragraph "The temperature of the ${tempSens4} is ${Sens4temp}бу."
            if (tempSens5)
            	paragraph "The temperature of the ${tempSens5} is ${Sens5temp}бу."
			}
		} 
	}
...
def mWeatherConfig() {
	dynamicPage(name: "mWeatherConfig", title: "Weather Settings") {
		section {
    		input "wMetric", "bool", title: "Report Weather In Metric Units\n(буC / km/h)", defaultValue: false, required: false, submitOnChange: true 
